...
#define MATCH 3
// #define CONFIG_5V5 "csgo/addons/sourcemod/configs/smp_5v5.cfg"
// #define CONFIG_WARMUP "addons/sourcemod/configs/smp_warmup.cfg"
...
{
	// todo: exec config file
	ServerCommand("mp_ct_default_secondary weapon_usp_hkp2000");
	...
	ServerCommand("bot_autodifficulty_threshold_high					0.0");
	ServerCommand("bot_autodifficulty_threshold_low					-2.0");
	ServerCommand("bot_chatter											normal");
	ServerCommand("bot_defer_to_human_goals							1");
	ServerCommand("bot_defer_to_human_items							1");
	ServerCommand("bot_difficulty										2");
	ServerCommand("bot_quota											1");
	ServerCommand("bot_quota_mode										competitive");
	...
	ServerCommand("cash_player_interact_with_hostage					300");
	...
	ServerCommand("cash_team_elimination_hostage_map_t					3000");
	ServerCommand("cash_team_elimination_hostage_map_ct					3000");
	ServerCommand("cash_team_hostage_alive								0");
	ServerCommand("cash_team_hostage_interaction						600");
	ServerCommand("cash_team_loser_bonus								1400");
	ServerCommand("cash_team_bonus_shorthanded							1000");
	ServerCommand("mp_starting_losses									1");
	ServerCommand("cash_team_loser_bonus_consecutive_rounds			500");
	ServerCommand("cash_team_planted_bomb_but_defused					800");
	ServerCommand("cash_team_rescued_hostage						600");
	ServerCommand("cash_team_terrorist_win_bomb						3500");
	ServerCommand("cash_team_win_by_defusing_bomb						3500");
	ServerCommand("cash_team_win_by_hostage_rescue						2900");
	...
	ServerCommand("mp_force_pick_time									15");
	ServerCommand("mp_forcecamera										1");
	ServerCommand("mp_free_armor										0		");
	ServerCommand("mp_freezetime										15");
	ServerCommand("mp_friendlyfire										1");
	ServerCommand("mp_win_panel_display_time							3");
	ServerCommand("mp_ggprogressive_round_restart_delay				15");
	ServerCommand("mp_ggtr_bomb_defuse_bonus							1");
	ServerCommand("mp_ggtr_bomb_detonation_bonus						1");
	ServerCommand("mp_ggtr_bomb_pts_for_flash							4");
	ServerCommand("mp_ggtr_bomb_pts_for_he								3");
	ServerCommand("mp_ggtr_bomb_pts_for_molotov						5");
	ServerCommand("mp_ggtr_bomb_pts_for_upgrade						2");
	ServerCommand("mp_ggtr_bomb_respawn_delay							0");
	ServerCommand("mp_ggtr_end_round_kill_bonus						1");
	ServerCommand("mp_ggtr_halftime_delay								0.0");
	ServerCommand("mp_ggtr_last_weapon_kill_ends_half					0");
	...
	ServerCommand("mp_roundtime_hostage								1.92");
	...
	ServerCommand("mp_technical_timeout_per_team						1");
	ServerCommand("mp_technical_timeout_duration_s						120");
	ServerCommand("mp_warmuptime										1");
	ServerCommand("mp_warmuptime_all_players_connected					1");
	ServerCommand("mp_weapons_allow_zeus								5");
	...
	ServerCommand("sv_auto_full_alltalk_during_warmup_half_end			1");
	ServerCommand("sv_arms_race_vote_to_restart_disallowed_after		0");
	ServerCommand("sv_deadtalk											1");
	ServerCommand("sv_ignoregrenaderadio								0");
	ServerCommand("tv_delay											105");
	...
	ServerCommand("mp_weapons_glow_on_ground							0");
	ServerCommand("mp_display_kill_assists								1");
