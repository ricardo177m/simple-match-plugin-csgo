...
#define MATCH 3
#define CONFIG_5V5 "addons/sourcemod/configs/smp_5v5.cfg"
...
{
	new Handle:configFile = OpenFile(CONFIG_5V5, "rt");

	decl String:linedata[256];

	while(!IsEndOfFile(configFile) && ReadFileLine(configFile, linedata, sizeof(linedata)))
	{
		decl length;
...
{
	new Handle:configFile = OpenFile(CONFIG_WARMUP, "rt");
